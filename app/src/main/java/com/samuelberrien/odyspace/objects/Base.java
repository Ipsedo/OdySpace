...
public class Base extends BaseItem {
    ...
    public void makeExplosion() {
        this.mExplosion = new Explosion(super.context, super.mPosition.clone(), super.diffColorBuffer, 40, 7f, 0.16f, 5f, 7f);
    }

    public void makeExplosion(ObjModel particule) {
        this.mExplosion = new Explosion(particule, super.mPosition.clone(), super.diffColorBuffer, 40, 7f, 0.16f, 5f, 7f);
    }
