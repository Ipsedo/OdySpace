	...
	private void setText() {
		...
		switch (kind) {
			case SHIP:
				...
				String life = "";
				if (index == 0) {
					int currentBoughtLife = savedShop.getInt(getContext().getString(R.string.bought_life), getResources().getInteger(R.integer.zero));
				...
				infos.setText(items[index] + System.getProperty("line.separator") + life + System.getProperty("line.separator") + "cost : " + cost);
				break;
			case FIRE:
				items = getResources().getStringArray(R.array.fire_shop_list_item);
				price = getResources().getIntArray(R.array.fire_shop_price);
				infos.setText(items[index] + System.getProperty("line.separator") + System.getProperty("line.separator") + "cost : " + price[index]);
				break;
			case BONUS:
				...
				String duration = "";
				if (index == 0) {
					int currentBoughtDuration = savedShop.getInt(getContext().getString(R.string.bought_duration), getResources().getInteger(R.integer.zero));
				...
				infos.setText(items[index] + System.getProperty("line.separator") + duration + System.getProperty("line.separator") + "cost : " + cost);
				break;
		}
	}
	...
	private void updateButton() {
		...
		switch (kind) {
				...
				if (index == 0) {
					buyButton.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View view) {
							int currMoney = savedShop.getInt(getContext().getString(R.string.saved_money),
									getResources().getInteger(R.integer.saved_init_money));
							int currentBoughtLife = savedShop.getInt(getContext().getString(R.string.bought_life),
									getResources().getInteger(R.integer.zero));
							int lifeCost = (int) Math.pow(currentBoughtLife, 2d) * price[index];
							if (currMoney >= lifeCost) {
								editor.putInt(getContext().getString(R.string.bought_life), currentBoughtLife + 1);
								editor.putInt(getContext().getString(R.string.saved_money), currMoney - lifeCost);
								editor.apply();
								setText();
							}
						}
					...
					buyButton.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View view) {
							...
							if (currMoney >= price[index]) {
								...
								editor.putInt(getContext().getString(R.string.saved_money), currMoney - price[index]);
								editor.apply();
								buyButton.setClickable(false);
								buyButton.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.drawer_button_pressed));
								//insertPrice(cost[index]);
							}
						}
					});
					rBool = items[index].equals(getContext().getString(R.string.ship_simple)) ? R.bool.vrai : R.bool.faux;
			...
			case FIRE:
				...
				rBool = items[index].equals(getContext().getString(R.string.fire_1)) ? R.bool.vrai : R.bool.faux;
				if (savedShop.getBoolean(items[index], getResources().getBoolean(rBool))) {
					buyButton.setClickable(false);
					buyButton.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.drawer_button_pressed));
				} else {
			...
			case BONUS:
				...
				if (index == 0) {
					buyButton.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							if (currMoney >= currentPrice) {
								editor.putInt(getContext().getString(R.string.bought_duration), currentBoughtDuration + 10);
								editor.putInt(getContext().getString(R.string.saved_money), currMoney - currentPrice);
								editor.apply();
								setText();
							}
						}
					...
					rBool = items[index].equals(getContext().getString(R.string.bonus_1)) ? R.bool.vrai : R.bool.faux;
					if (savedShop.getBoolean(items[index], getResources().getBoolean(rBool))) {
						buyButton.setClickable(false);
						buyButton.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.drawer_button_pressed));
					} else {
