...
inline void computeEdges(float v0[3], float v1[3], const float p0[3], const float p1[3], const float p2[3])
{
    v0[0] = p1[0]-p0[0];
    v0[1] = p1[1]-p0[1];
    v0[2] = p1[2]-p0[2];
...
bool triangle_intersection(float p0[3], float p1[3], float p2[3], float q0[3], float q1[3], float q2[3]){
