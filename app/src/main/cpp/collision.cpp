...
bool areCollided(float *items1Points, int nbEl1, float *item1Model, float *items2Points, int nbEl2,
                 float *item2Model) {

    for (int i = 0; i < nbEl1 / 9; i++) {
        int currI = i * 9;
        glm::vec4 u0 = glm::vec4(items1Points[currI + 0], items1Points[currI + 1],
                                 items1Points[currI + 2], 1.0);
        glm::vec4 u1 = glm::vec4(items1Points[currI + 3], items1Points[currI + 4],
                                 items1Points[currI + 5], 1.0);
        glm::vec4 u2 = glm::vec4(items1Points[currI + 6], items1Points[currI + 7],
                                 items1Points[currI + 8], 1.0);
        ...
        items1Points[currI + 0] = u0[0];
        items1Points[currI + 1] = u0[1];
        items1Points[currI + 2] = u0[2];

        items1Points[currI + 3] = u1[0];
        items1Points[currI + 4] = u1[1];
        items1Points[currI + 5] = u1[2];

        items1Points[currI + 6] = u2[0];
        items1Points[currI + 7] = u2[1];
        items1Points[currI + 8] = u2[2];
    }

    for (int i = 0; i < nbEl2 / 9; i++) {
        int currI = i * 9;
        glm::vec4 vvec0 = glm::vec4(items2Points[currI + 0], items2Points[currI + 1],
                                    items2Points[currI + 2], 1.0);
        glm::vec4 vvec1 = glm::vec4(items2Points[currI + 3], items2Points[currI + 4],
                                    items2Points[currI + 5], 1.0);
        glm::vec4 vvec2 = glm::vec4(items2Points[currI + 6], items2Points[currI + 7],
                                    items2Points[currI + 8], 1.0);
        ...
        double v0[] = {vvec0[0], vvec0[1], vvec0[2]};
        double v1[] = {vvec1[0], vvec1[1], vvec1[2]};
        double v2[] = {vvec2[0], vvec2[1], vvec2[2]};

        for (int j = 0; j < nbEl1 / 9; j++) {
            int currJ = j * 9;
            double u0[] = {items1Points[currJ + 0], items1Points[currJ + 1],
                           items1Points[currJ + 2]};
            double u1[] = {items1Points[currJ + 3], items1Points[currJ + 4],
                           items1Points[currJ + 5]};
            double u2[] = {items1Points[currJ + 6], items1Points[currJ + 7],
                           items1Points[currJ + 8]};

            /*if(triangle_intersection(v0, v1, v2, u0, u1, u2) && triangle_intersection(u0, u1, u2, v0, v1, v2)) {
                return true;
            }*/
            if (tri_tri_overlap_test_3d(v0, v1, v2, u0, u1, u2) == 1) {
                return true;
            }
        }
    }
...
JNIEXPORT jboolean JNICALL
Java_com_samuelberrien_odyspace_drawable_maps_NoiseMap_areCollided(JNIEnv *env, jobject instance,
                                                                   jfloatArray mPointItem1_,
                                                                   jfloatArray mModelMatrix1_,
                                                                   jfloatArray mPointItem2_,
                                                                   jfloatArray mModelMatrix2_) {
